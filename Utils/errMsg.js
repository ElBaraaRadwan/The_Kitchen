...
const STRIPE_TRANSACTION_FAILED = 'Stripe transaction failed';
const EMAIL_EXISTS = 'Email already exists';
const EMAIL_IS_CURRENT = 'Email provided is your current email'
...
export { SIGN_UP_ERR_MSG, USER_WITH_EMAIL_EXISTS_MSG, NO_JWT_SECRET_MSG, NO_JWT_EXPIRY_TIME_MSG,NO_EMPTY_FIELD, 
    ...
    SHORT_PASSWORD,WEAK_PASSWORD,INVALID_EMAIL,ERROR_SAVING_ORDER,PAYPAL_TRANSACTION_FAILED,USER_ID_REQUIRED,ERROR_FETCHING_ORDERS,
    NAME_NOT_FOUND,EMAIL_NOT_FOUND,STRIPE_TRANSACTION_FAILED,EMAIL_EXISTS,EMAIL_IS_CURRENT,AUTHENTICATION_FAILED};